 ...
 */
export function toPhysicalIdentifier(identifier) {
    if (!identifier)
        return identifier;
    if (identifier === '*')
        return identifier;
 ...
 */
export function qualifyName(name, credentials, includeSchema = true) {
 ...
 */
export function getSimpleName(qualifiedName) {
 ...
 */
export function columnRef(column, alias) {
